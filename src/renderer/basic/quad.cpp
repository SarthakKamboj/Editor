...
shader_uniform_t quad_t::quad_tex_influence_uniform{};
...
void init_quad_data() {
    ...
    quad_t::quad_tex_influence_uniform = create_shader_uniform(quad_shader, "tex_influence", shader_uniform_type::FLOAT);
}
